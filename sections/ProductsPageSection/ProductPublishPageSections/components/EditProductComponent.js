...
How to get this as ["Green / Large", "Green / XL", "Yellow / Large", "Yellow / XL", "Orange / Large", "Orange / XL"]
  ...
  const staticData = [
    {
      ...
      route: `/app/products/edit/${productId}?tab=general-info`,
    },
    {
      label: "Price",
      component: (
      ...
      route: `/app/products/edit/${productId}?tab=price-info`,
    ...
    },
    {
      ...
      route: `/app/products/edit/${productId}?tab=inventory`,
    },
    {
      label: "Variants",
      component: (
        <>
          ...
          <ProductOnboardingOptionsInfoSection
            ...
            handleChangeProductOptionsFields={handleChangeProductOptionsFields}
            handleChangeProductOptionsName={handleChangeProductOptionsName}
      ...
      route: `/app/products/edit/${productId}?tab=options-variants`,
    },
    {
      label: "Product Media",
      component: (
      ...
      route: `/app/products/edit/${productId}?tab=product-media`,
    },
  ];
  ...
  const handleSaveChanges = () => {
    ...
    const data = {
      ...
      channel_id: 1,
      collection: collection,
      display_image: productDataFromStore.display_image,
      images: productDataFromStore.images,
      items: productDataFromStore.items,
      live_date: productDataFromStore.live_date,
      master_product_id: productDataFromStore.master_product_id,
      product_desc: sessionDescription,
      product_title: title,
