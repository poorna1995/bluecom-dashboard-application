...
export default function NewBulkPublishPageReviewProductsPageSection({
  ...
  if (status === "success")
    return (
      <ProductPublishPagePublishSuccessSection productsList={filteredData} />
    );
          ...
          getProductsDataWithErrors.map((product, index) => {
            return (
              <ProductPublishSection
                ...
                item_unit_cost_price={product.item_unit_cost_price}
        ...
        <>
          ...
          >
            ...
            <PrimaryButton
              ...
              disabled={
                isLoading
                // || getErrorCount > 0 || publishLoading
              }
            >
              {/* Publish Product */}
              Continue
