...
import { MdChevronRight, MdMoreHoriz, MdMoreVert } from "react-icons/md";

export default function MobileViewVendorCard({ data = {} }) {
  console.log({ data });
  return (
    <Box
      sx={{
    ...
    >
      ...
      >
        <AppLink
          ...
          href={`/app/vendors/${data.vendor_id}?tab=overview`}
        >
          {data.company_name}
        </AppLink>
        <Typography
        ...
        >
          {data.product_count} Products. {data.vendor_lead_time} days Lead Time
        </Typography>
        <RenderPaymentMethod value={data.payment_method} />
      </Box>
      <Box sx={{ display: "flex", flexDirection: "column" }}>
        ...
        >
          ...
          >
            ...
            >
              <path
                d="M1.18333 0.333661L7.85 7.00033L1.18334 13.667L2.28074e-06 12.4837L5.48333 7.00033L1.322e-06 1.51699L1.18333 0.333661Z"
                fill="#595959"
              />
            </svg>
            {/* <MdChevronRight color={"#595959"} /> */}
          </IconButton>
        </Box>
        <Box
          sx={{
